  ...
  return (
    <div className='tasks'>
      <div className='tasks__title'>
        ...
        <h2 className='tasks__title__text'>All Posts</h2>
      </div>
      <div className='tasks__sort'>
        <DropDown chnageCatagory={handlechange} all={all} />
        <motion.button onClick={deleteAll} whileTap={{scale:.9}} className='clear-all' >Clear All Posts</motion.button>
      </div>
      <div className='tasks__container'>
        <AnimatePresence>
          {tasks.length !== 0 ? (
            ...
            <h4 className='nothing'>You dont have any posts</h4>
          )}
        </AnimatePresence>
      </div>
    </div>
